// Make a function that is able to generate a grid of letters
// that is 15x15 in size. The grid should be a 2D array of letters.
// The letters should be randomly generated and should be used to build the grid.
// Print the grid to a window.
